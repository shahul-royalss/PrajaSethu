...
const extras: Record<string, Dict> = {
  ...
  te: {
    ...
    onbTitle: 'స్వాగతం! మీ గురించి చెప్పండి',
    onbSubtitle: 'ఒక్కసారే — ఇక ప్రతి ఫిర్యాదులో మీ వివరాలు ఆటోమేటిక్‌గా నింపబడతాయి. ప్రొఫైల్ నుండి ఎప్పుడైనా మార్చుకోవచ్చు.',
    onbSave: 'సేవ్ చేసి కొనసాగండి',
    onbNote: 'మీ వివరాలు ఫిర్యాదుల వ్యవస్థలోనే ఉంటాయి — మీ ఫిర్యాదు చూసే అధికారికి మాత్రమే కనిపిస్తాయి.',
    profTitle: 'నా ప్రొఫైల్',
    profSubtitle: 'ఈ వివరాలు ప్రతి ఫిర్యాదులో ఆటోమేటిక్‌గా నింపబడతాయి',
    profSave: 'మార్పులు సేవ్ చేయండి',
    profSaved: 'ప్రొఫైల్ నవీకరించబడింది',
    profName: 'పూర్తి పేరు',
    profNamePh: 'ఉదా: రమేష్ కుమార్',
    profGender: 'లింగం',
    profGender_MALE: 'పురుషుడు',
    profGender_FEMALE: 'స్త్రీ',
    profGender_OTHER: 'ఇతర',
    profDistrict: 'జిల్లా',
    profMandal: 'మండలం',
    profVillage: 'గ్రామం / వార్డు',
    profHouse: 'ఇంటి నంబర్ (ఐచ్ఛికం)',
